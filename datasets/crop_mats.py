...
def main():
    ...
    main_folder = '/cache/liulin/pixelshift/'
    input_folder = '/cache/liulin/pixelshift/val/'
    select_folder = os.path.join(main_folder, 'PixelShift200_val_crop')
    waste_folder = os.path.join(main_folder, 'waste_val_mat')
    img_folder = os.path.join(main_folder, 'img_val_crop')
    waste_img_folder = os.path.join(main_folder, 'waste_val_img')
